package com.ohgiraffers.crud_back.outdoor.model.dto;
...
public class OutdoorDTO{
    ...
    public OutdoorDTO(Long id, String name, String address, String phone, String feature, String opr_info, String opr_hours, String ent_fee, String web_url, String imagePath) {
        this.id = id;
        this.name = name;
